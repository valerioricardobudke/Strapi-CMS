        ...
        <div className="container-fluid">
          <nav className="navbar navbar-expand-lg navbar-light bg-light">
                            ...
                            <ul className="megamenu-submenu">
                              ...
                              <li className="nav-item">
                                <Link
                                  ...
                                  className={`nav-link ${
                                    currentPath == "/portfolio/portfolio-1/" &&
                                    "active"
                                  }`}
                                >
                                  Classic Two Column
                  ...
                  <ul className="dropdown-menu">
                    ...
                    <li className="nav-item">
                      <Link
                        href="/blogs/blog-left-sidebar/"
                        className={`nav-link ${
                          currentPath == "/blogs/blog-left-sidebar/" && "active"
                        }`}
                      >
                        Blog Left Sidebar
                      </Link>
                    ...
                    <li className="nav-item">
                      <Link
                        href="/blogs/blog-right-sidebar/"
                        className={`nav-link ${
                          currentPath == "/blogs/blog-right-sidebar/" && "active"
                        }`}
                      >
                        Blog Right Sidebar
                      </Link>
            ...
            <div className="others-option">
              <Link href="/pricing" className="btn-style-one white-color">
